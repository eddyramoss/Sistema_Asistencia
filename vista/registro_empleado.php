...
<div class="page-content">
	...
	<h4 class="text text-center text-secondary">REGISTRO DE EMPLEADOS</h4>
   ...
   ?>
	<div class="row">
		<form action="" method="POST">
			...
			<div class="fl-flex-label mb-4 px-2 col-12 col-md-6">
				<input type="text" placeholder="Carnet" class="input input__text" name="txtcarnet">
			</div>
			<div class="fl-flex-label mb-4 px-2 col-12 col-md-6 ">
