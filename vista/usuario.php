...
<div class="page-content">
	...
	<h4 class="text text-center text-secondary">LISTA DE USUARIOS</h4>
   ...
   ?>
	<div class="text-right ">
		<a href="fpdf/ReporteUsuario.php" target="_blank" class="btn btn-success"><i
	...
	<table class=" table-bordered table-hover col-12" id="example">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="" data-toggle="modal"
						data-target="#modal-<?=$datos->id_usuario?>"
						class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
					<a href="usuario.php?id=<?=$datos->id_usuario?>"
			...
			<div class="modal fade"
				id="modal-<?=$datos->id_usuario?>" tabindex="-1"
