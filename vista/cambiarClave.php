	...
	<div class="row">
		<form action="" method="POST">
			...
			<div hidden class="fl-flex-label mb-4 px-2 col-12 col-md-6">
				<input type="number" placeholder="ID" class="input input__text" name="txtid"
					value="<?=$datos->id_usuario?>">
			</div>
			<div class="fl-flex-label mb-4 px-2 col-12 ">
				<input type="text" placeholder="Contraseña Actual" class="input input__text" name="txtclaveactual"
					value="">
			</div>
			<div class="fl-flex-label mb-4 px-2 col-12 ">
				<input type="text" placeholder="Contraseña Nueva" class="input input__text" name="txtclavenueva"
					value="">
			</div>
