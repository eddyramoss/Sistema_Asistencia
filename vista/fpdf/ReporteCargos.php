...
class PDF extends FPDF
{
    ...
    public function Header()
    {
      ...
      //color
        ...
        $this->Cell(85, 10, utf8_decode('NOMBRE'), 1, 1, 'C', 1);
    }
...
while ($datos_reporte = $consulta_reporte_cargo->fetch_object()) {
    ...
    $pdf->Cell(85, 10, utf8_decode($datos_reporte->nombre), 1, 1, 'C', 0);
}



$pdf->Output('Reporte_Cargos.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
