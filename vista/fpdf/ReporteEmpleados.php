...
$consulta_reporte_empleado = $conexion->query("SELECT empleado.nombre,empleado.apellido,empleado.ci,cargo.nombre as 'cargo' from empleado
...
while ($datos_reporte = $consulta_reporte_empleado->fetch_object()) {
    ...
    $pdf->Cell(85, 10, utf8_decode($datos_reporte->nombre. " " .$datos_reporte->apellido), 1, 0, 'C', 0);
    $pdf->Cell(30, 10, utf8_decode($datos_reporte->ci), 1, 0, 'C', 0);
    $pdf->Cell(40, 10, utf8_decode($datos_reporte->cargo), 1, 1, 'C', 0);
}
