...
<div class="page-content">
   ...
   ?>
	<div class="text-right mb-3">
		<a href="fpdf/ReporteAsistenciaH.php" target="_blank" class="btn btn-success"><i
				class="fa-solid fa-file-pdf"></i>Generar Reporte</a>
	</div>
	<div class="text-right mb-3">
	...
	<table class="table table-bordered table-hover col-12" id="example">
		...
		<tbody>
			...
			<tr>
				...
				<td><?= $datos->nom_empleado . " ". $datos->apellido ?>
				</td>
				<td><?= $datos->ci?></td>
				...
				<td><?= $datos->salida ?></td>
				<td>
					<a href="inicio.php?id=<?=$datos->id_asistencia?>"
