...
<div class="page-content">
	...
	<h4 class="text text-center text-secondary">LISTA DE EMPLEADOS</h4>
   ...
   ?>
	<div class="text-right">
		<a href="fpdf/ReporteEmpleados.php" target="_blank" class="btn btn-success"><i
				class="fa-solid fa-file-pdf"></i>Generar
			Reporte</a>
	</div>
	<a href="registro_empleado.php" class="btn btn-primary btn-rounded mb-3"><i class="fa-solid fa-plus"></i>
		&nbsp;Registrar</a>
	<table class=" table-bordered table-hover col-11" id="example">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="" data-toggle="modal"
						data-target="#exampleModal-<?= $datos->id_empleado?>"
						class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
					<a href="empleado.php?id=<?=$datos->id_empleado?>"
						onclick="advertencia(event)" class="btn btn-danger btn-sm"><i
			...
			<div class="modal fade"
				id="exampleModal-<?= $datos->id_empleado?>"
						...
						<div class="modal-body">
							<form action="" method="POST">
								...
								<div class="fl-flex-label mb-4 px-2 col-12">
									<input type="text" placeholder="Editar Nombre" class="input input__text"
										name="txtnombre"
										value="<?= $datos->nombre?>">
								</div>
								<div class="fl-flex-label mb-4 px-2 col-12">
									<input type="text" placeholder="Editar Apellido" class="input input__text"
										name="txtapellido"
										value="<?= $datos->apellido?>">
								</div>
								<div class="fl-flex-label mb-4 px-2 col-12">
									<input type="text" placeholder="Editar Carnet" class="input input__text"
										name="txtci"
										value="<?= $datos->ci?>">
								</div>
								<div class="fl-flex-label mb-4 px-2 col-12">
